...
from longdpo_trainer import LongDPOTrainer, LongDPORingTrainer, LongDPOUlyssesTrainer, LongDPOJointUlyssesTrainer, LongDPOJointSeqUlyssesTrainer
...
def train():
    ...
    train_dataset = get_long_dpo_dataset(data_args.data_path)
    eval_dataset = None
    ...
    TRAINER_CLASS = LongDPOJointSeqUlyssesTrainer
    ########################
