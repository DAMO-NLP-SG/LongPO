...
from longdpo_trainer import LongDPOTrainer, LongDPORingTrainer, LongDPOUlyssesTrainer, LongDPOJointUlyssesTrainer, LongDPOFullJointUlyssesTrainer
...
def train():
    ...
    TRAINER_CLASS = LongDPOFullJointUlyssesTrainer
    ########################
