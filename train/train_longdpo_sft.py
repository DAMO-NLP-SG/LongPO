...
from longdpo_trainer import LongDPOTrainer, LongDPORingTrainer, LongDPOUlyssesTrainer, LongDPOJointUlyssesTrainer
...
def train():
    ...
    train_dataset = get_long_dpo_dataset(data_args.data_path).shuffle(seed=42)
    eval_dataset = None
    ...
    TRAINER_CLASS = LongDPOJointUlyssesTrainer
    ########################
